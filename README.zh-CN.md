...
所有这些入口都在 Typecho 后台的“插件 → SuiteMonitor → 设置”：最上方的“监控品牌名称 / 标识 / 头像地址”就是个人信息；“监控顶部导航”控制控制台、首页、落地页及自定义链接；“页脚链接开关”控制代码仓库是否出现。品牌字段留空会自动沿用主题设置中的站点名称、作者标识和头像。详细的“关于我的事”则在“外观 → 设置 → 关于页详细简介”中填写，关于页会优先使用这里的内容。
