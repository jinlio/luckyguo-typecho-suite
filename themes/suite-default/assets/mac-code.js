// suite theme - macOS-style code block initializer (v3)
...
(() => {
  ...
  if (Prism.plugins && Prism.plugins.autoloader) {
    var loader = document.querySelector('script[data-autoloader-path]');
    Prism.plugins.autoloader.languages_path = loader
      ? (loader.getAttribute('data-autoloader-path') || loader.src.replace(/[^/]+$/, 'prism/'))
      : 'assets/prism/';
  }
